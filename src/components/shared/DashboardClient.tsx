...
const monthAppointments = mockAppointments.filter((a) => a.date >= thisMonth);
const monthRevenue = monthAppointments.reduce((sum, a) => sum + a.price, 0);
const atRiskClients = mockClients.filter((c) => c.status === "AT_RISK");
          ...
          <ResponsiveContainer width="100%" height={200}>
            <LineChart data={mockWeeklyData}>
              ...
              <Line
                ...
                stroke="oklch(0.620 0.241 355)"
                strokeWidth={2}
                dot={{ r: 4, fill: "oklch(0.620 0.241 355)" }}
              />
            </LineChart>
          </ResponsiveContainer>
        </div>
